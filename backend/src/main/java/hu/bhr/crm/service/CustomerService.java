...
public class CustomerService {
    ...
    public Customer registerCustomer(Customer customer) {
        ...
        // Return CustomerEntity directly from DB
        CustomerEntity reloadedCustomerEntity = repository.findById(savedCustomerEntity.getId()).
                orElseThrow(() -> new CustomerNotFoundException("Customer not found after save"));
        
        return customerMapper.customerEntityToCustomer(reloadedCustomerEntity);
    }
}
