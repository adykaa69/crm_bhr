...
public class TaskService {
    ...
    public TaskService(TaskRepository taskRepository, TaskMapper taskMapper, @Lazy CustomerService customerService) {
    ...
    public void updateCustomerRelatedTasks(UUID customerId) {
